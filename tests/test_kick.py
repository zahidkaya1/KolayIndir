...
class TestKickMetadataStructure:
    ...
    def test_kick_source_name_always_kick(self):
        ...
        assert get_platform_badge_text(meta.platform_type) == "Kick"
