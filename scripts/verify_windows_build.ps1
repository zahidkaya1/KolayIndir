...
if ($VerInfo.FileVersion -ne "1.1.1.1") {
    Write-Error "FileVersion is '$($VerInfo.FileVersion)', expected '1.1.1.1'"
    exit 1
}
Write-Host "[OK] Version metadata verified (ProductName: Loadvia, FileVersion: 1.1.1.1)" -ForegroundColor Green
